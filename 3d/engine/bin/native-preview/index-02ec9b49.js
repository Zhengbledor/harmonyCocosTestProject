System.register(['./index-cdf65239.js', './find-a2ac9aec.js', './device-62ae3c0d.js', './sprite-8c051f15.js', './deprecated-7d2716fb.js', './sprite-renderer-35a5528d.js', './builtin-res-mgr.jsb-782de3de.js', './touch-28f50917.js', './deprecated-158528dd.js', './renderer-259bfa66.js', './director-cf2afd11.js', './rendering-sub-mesh.jsb-361ed7d8.js', './node-event-41e0592a.js', './scene-asset.jsb-81748dae.js', './cached-array-848bd3ae.js'], (function (exports) {
    'use strict';
    var Mat4, clamp$1, Color, Vec3, Rect, logID, Vec2, legacyCC, log, warn, addon, mixin, approx, errorID, error, remove, removeAt, Pool, assert, assertIsTrue, EPSILON$1, markAsWarning, replaceProperty, removeProperty, warnID, ccwindow, deviceManager, FormatInfos, DescriptorSetInfo, BufferInfo, BufferUsageBit, MemoryUsageBit, PrimitiveMode, CanvasPool, Overflow$1, BASELINE_RATIO, safeMeasureText, fragmentText, HorizontalTextAlignment, VerticalTextAlignment, shareLabelInfo, isUnicodeSpace, isUnicodeCJK, getBaselineOffset, LetterAtlas, FontAtlas, CacheMode, computeHash, Label, BitmapFont, Sprite, TTFFont, LineJoin, LineCap, Point, PointFlags, Graphics, DrawBatch2D, SpriteFrame, view, dynamicAtlasManager, StencilManager, vfmtPosUvColor, getAttributeStride, StaticVBAccessor, Stage, vfmt, MeshBuffer, MeshRenderData, RenderData, WrapMode, Input, EventDispatcherPriority, input, NodeEventProcessor, DispatcherEventType, Material, builtinResMgr, Model, ModelLocalBindings, UBOLocal, downloader, factory, InputEventType, EventTouch, RenderingSubMesh, CachedArray;
    return {
