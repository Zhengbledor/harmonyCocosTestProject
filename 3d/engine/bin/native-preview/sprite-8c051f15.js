System.register(['./index-cdf65239.js', './node-event-41e0592a.js', './sprite-renderer-35a5528d.js', './rendering-sub-mesh.jsb-361ed7d8.js', './builtin-res-mgr.jsb-782de3de.js', './scene-asset.jsb-81748dae.js', './find-a2ac9aec.js', './director-cf2afd11.js', './device-62ae3c0d.js'], (function (exports) {
    'use strict';
    var ccclass, applyDecoratedInitializer, legacyCC, createMap, getClassId, serializable, override, string, type, warn, mixin, Pool, Color, ccwindow, macro, warnID, Size, Rect, Vec2, ccenum, executionOrder, clamp, Asset, _applyDecoratedDescriptor, extname, SpriteFrame, UIRenderer, InstanceMaterialType, ImageAsset, Texture2D, PixelFormat, TextureBase, Material, RenderTexture, director, Director, BufferTextureCopy;
    return {
        ...
        execute: (function () {
            ...
            exports({
                e: isUnicodeSpace,
                f: isEnglishWordPartAtFirst,
                g: getBaselineOffset,
                h: isEnglishWordPartAtLast,
                i: isUnicodeCJK,
                j: getEnglishWordPartAtFirst,
                k: getEnglishWordPartAtLast,
                l: fragmentText,
                q: computeHash,
                s: safeMeasureText
            });
            ...
            } exports('o', LetterAtlas);
            const shareLabelInfo = exports('n', {
              fontAtlas: null,
              fontSize: 0,
              lineHeight: 0,
              hAlign: 0,
