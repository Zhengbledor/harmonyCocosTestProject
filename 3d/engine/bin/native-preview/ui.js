System.register(['./node-event-41e0592a.js', './index-cdf65239.js', './sprite-renderer-35a5528d.js', './sprite-8c051f15.js', './builtin-res-mgr.jsb-782de3de.js', './find-a2ac9aec.js', './xr-event-handle-4dac0a50.js', './director-cf2afd11.js', './deprecated-88c49970.js', './touch-28f50917.js', './camera-component-4ee32ea3.js', './rendering-sub-mesh.jsb-361ed7d8.js', './scene-asset.jsb-81748dae.js', './decorators-f21c5b0b.js', './device-62ae3c0d.js', './pipeline-sub-state.jsb-4e7eafde.js', './murmurhash2_gc-2108d723.js', './deprecated-cdde63bd.js', './model-renderer-52e7f62a.js', './renderer-259bfa66.js', './create-mesh.jsb-a12ceaf9.js', './buffer-ad75ba4d.js'], (function (exports) {
    'use strict';
    var _applyDecoratedDescriptor, EventHandler, Component, NodeEventType, Color, ccenum, ccclass, type, applyDecoratedInitializer, legacyCC, executionOrder, requireComponent, Vec3, lerp, serializable, Enum, ccwindow, Mat4, contains, sys, OS, screenAdapter, BrowserType, visibleRect, MINIGAME, JSB, RUNTIME_BASED, Size, warn, Vec2, clamp01, logID, errorID, approx, EDITOR_NOT_IN_PREVIEW, editorOnly, override, warnID, MutableForwardIterator, EPSILON$1, CCObject, deprecateModuleExportedName, setClassAlias, removeProperty, markAsWarning, UITransform, SpriteFrame, UIRenderer, View, view, Sprite, BitmapFont, Label, VerticalTextAlignment, Node, TransformBit, input, Input, EventGamepad, EventHandle, Scene, ImageAsset, Texture2D, XrUIPressEventType, XrKeyboardEventType, DeviceType, director, Director, game, KeyCode, EventTouch, SystemEventType, Event, Camera;
    return {
