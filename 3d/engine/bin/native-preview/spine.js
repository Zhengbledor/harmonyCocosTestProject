System.register(['./index-cdf65239.js', './node-event-41e0592a.js', './rendering-sub-mesh.jsb-361ed7d8.js', './builtin-res-mgr.jsb-782de3de.js', './scene-asset.jsb-81748dae.js', './find-a2ac9aec.js', './sprite-renderer-35a5528d.js', './impl-73464bf7.js', './deprecated-88c49970.js', './director-cf2afd11.js', './index-02ec9b49.js', './deprecated-158528dd.js', './renderer-259bfa66.js', './deprecated-7d2716fb.js', './deprecated-cdde63bd.js', './device-62ae3c0d.js', './decorators-f21c5b0b.js', './touch-28f50917.js', './pipeline-sub-state.jsb-4e7eafde.js', './murmurhash2_gc-2108d723.js', './camera-component-4ee32ea3.js', './create-mesh.jsb-a12ceaf9.js', './buffer-ad75ba4d.js', './model-renderer-52e7f62a.js', './sprite-8c051f15.js', './cached-array-848bd3ae.js'], (function (exports) {
    'use strict';
    var warn, ccclass, type, applyDecoratedInitializer, legacyCC, CCString, error, Enum, serializable, System, Mat4, ccenum, setClassAlias, override, logID, Color, setPropertyEnumType, CCObject, Vec3, Asset, _applyDecoratedDescriptor, Texture2D, Node, Material, builtinResMgr, getAttributeStride, vfmtPosUvColor4B, vfmtPosUvTwoColor4B, UIRenderer, RenderEntity, RenderEntityType, StaticVBAccessor, RenderData, director, MaterialInstance, Graphics, RecyclePool, BlendOp, BlendFactor;
    return {
        ...
        execute: (function () {
            ...
            class AnimationCache {
              ...
              updateRenderData(index, model) {
                ...
                const HEAPU8 = spine$2.wasmUtil.wasm.HEAPU8;
            ...
            class SkeletonCache {
              ...
              destroySkeleton(assetUuid) {
                ...
                if (skeletonInfo.skeleton) {
                  spine$2.wasmUtil.destroySpineSkeleton(skeletonInfo.skeleton);
                }
              ...
              createSkeletonInfo(skeletonAsset) {
                ...
                const skeleton = new spine$2.Skeleton(runtimeData);
                const clipper = null;
                const state = null;
